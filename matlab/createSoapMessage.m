...
%
% This file is part of Matlab-Fast-SOAP - a faster Matlab replacement
% for the default SOAP functions. Written by:
% 
...
function xml = createXML(data)
    ...
    for n=1:numel(data)
        ...
        switch valClass
            ...
            case 'double'
                xml = [xml wrapXML(name, type, wrapXML(wrap, '', num2str(val(:), '%1.8g')))];   % Changed format string / T. Laitinen
