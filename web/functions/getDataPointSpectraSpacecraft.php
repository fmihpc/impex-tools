...
// #####################################################################################################
//
// 								      getDataPointSpectraSpacecraft.php
//
// #####################################################################################################
...
//											FMI supports ASCII, VOTable and netCDF (default).
...
function getDataPointSpectraSpacecraft($params) {

	// --------------------------------
	// Log caller info and method name
	// --------------------------------

	log_method("getDataPointSpectraSpacecraft", $params);
	...
	$point_file_name = get_spacecraft_orbit_AMDA($Format = "VOTable", $InputParams);
