...
function filestr = getDataPointSpectraSpacecraft( resourceID, sc, start, stop, sampling, fileName, varargin )
% GETDATAPOINTSPECTRASPACECRAFT  Get simulation data from FMI IMPEx server on a spacecraft track.
%
% Required parameters:
...
%
% See also: GETDATAPOINTSPECTRA, GETDATAPOINTVALUESPACECRAFT
...
%     sampling = sprintf( 'PT%iS', sampling );
end
